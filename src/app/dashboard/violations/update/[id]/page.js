...
export default function Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${API_BASE_URL}/violations/update/${id}`, formDataToSend, {
                headers: {
    ...
    return (
        <div className='md:w-1/2'>
            ...
            >
                <h4 className='text-xl font-semibold mb-6'>Updated Traffic Violation</h4>
                ...
                {success && <p className='text-green-600'>Successfully updated the Violation</p>}
